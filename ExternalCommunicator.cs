...
//    RewardPredictCommunicator rewardPredictCommunicator;
...
//        rewardPredictCommunicator = aca._rewardPredictCommunicator;
//    }
...
//        accParamerters.useRewardPredict = (rewardPredictCommunicator != null).ToString();
...
//                break;
//            case "RECORD":
//                command = ExternalCommand.RECORD;
//                break;
//            case "EXIT":
//                command = ExternalCommand.EXIT;
//                break;
//            default:
//                command = ExternalCommand.QUIT;
//                break;
